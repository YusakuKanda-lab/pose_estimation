...
def rightarm_detect(xys):
    if 'left wrist' in xys and 'nose' in xys and 'left shoulder' in xys:
        wx,wy = xys['left wrist']
        sx,sy = xys['left shoulder']
        nx,ny = xys['nose']
        return(wy < ny and wy < sy)
...
def main():
 ...
 #   myline = LINENotifyBot(access_token = "5fr0uMflkLNzcduBXWx42p81OdlEmH73hQ7OuYl5qgM")
